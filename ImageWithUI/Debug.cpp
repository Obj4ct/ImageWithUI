#include"Debug.h"
void Debug::ImgInfo(BMP &inBmp, BMPInfo &inBmpInfo)
{
...
int Debug::ReadBinTxt(const std::string &inName, const std::string &outName)
{
...
// 保存二进制
int Debug::outputBinToFile(std::vector<uint8_t> &imageData, const std::string &name)
{
    // open output file
...
//保存像素
int Debug::OutputPixToFile(std::vector<uint8_t> &imageData, const std::string &name)
{
    // open output file
...
void Debug::TempImage(std::vector<uint8_t> &imageData, const std::string &name, BMP &bmp, BMPInfo &bmpInfo)
{
    // open output file
...
// 十六进制
void Debug::WriteBMPHexToFile(const std::string &inputFileName, const std::string &outputFileName)
{
...
void Debug::PrintImagePixelsToFile(const QImage& image, const QString& filePath) {
    QFile file(filePath);
